...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_ALL_WINDOWS]      = ACTION_TAP_DANCE_DOUBLE(LCTL(KC_UP), LCTL(KC_DOWN)),
  [TD_ALL_APPLICATIONS] = ACTION_TAP_DANCE_DOUBLE(KC_TRANSPARENT, LCTL(KC_UP))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(
               ...
               TD(TD_ESCAPE_CAPS),   KC_A,ALT_T(KC_S),CTL_T(KC_D),GUI_T(KC_F),KC_G,
               KC_LSHIFT,   KC_Z,KC_X,KC_C,KC_V,KC_B,        CTL_T(KC_GRAVE),

               // Left bottom row
               KC_LCTL,KC_LALT,GUI_T(KC_NO),KC_TRANSPARENT,LT(8,KC_PGUP),
               ...
               KC_TRANSPARENT,      KC_Y,KC_U,KC_I,KC_O,KC_P,   KC_BSLASH,
                                   KC_H,GUI_T(KC_J),CTL_T(KC_K),KC_L,KC_SCOLON,           RCTL_T(KC_QUOTE),
               CTL_T(KC_QUOTE),    KC_N,KC_M,TD(TD_CC_TERMINAL),KC_DOT,KC_SLASH,   KC_RSHIFT,

               // Right bottom row
               LT(7,KC_PGDOWN),KC_LEAD,KC_MINUS,KC_EQUAL,TT(6),

               // Right Thumb Cluster
               LGUI(KC_ESCAPE) ,LCTL(LSFT(KC_SPACE)),
               KC_TRANSPARENT,
               KC_RBRACKET,     TD(TD_ALL_WINDOWS),    LT(6, KC_ENTER)
  ),
